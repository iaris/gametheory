...
game_length = 100 #ゲームの長さを指定
program_length = 10000 #プログラムをどれだけ回すかを指定
...
for j in  range(program_length): #プログラムを繰り返し回す
    ...
    for i in range(game_length):
        ...
        if current_belief0 > 0.3333333333333333333333333333333: #プレイヤー0の行動を指定
            player0_play = 1
        else:
            player0_play = 0
        
        if current_belief1 > 0.3333333333333333333333333333333: #プレイヤー1の行動を指定
            player1_play = 1
        else:
            player1_play = 0
